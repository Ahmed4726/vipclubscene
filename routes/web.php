...
// Posts
Route::get('activity/{post}', 'PostsController@singlePost')->name('single-post');
...
Route::get('delete-activity/{post}', 'PostsController@deletePost')->name('deletePost');
Route::get('post/loadById/{post}', 'PostsController@loadAjaxSingle')->name('loadPostById');
Route::get('activity/loadMore/{lastId}', 'PostsController@ajaxFeed')->name('loadMorePosts');
Route::get('activity/delete-media/{post}', 'PostsController@deleteMedia')->name('deleteMedia');
Route::get('activity/download-zip/{post}', 'PostsController@downloadZip')->name('downloadZip');
...
// Browse Creators
Route::get('explore-pages/{category?}/{category_name?}', 'BrowseCreators@browse')->name('browseCreators');
