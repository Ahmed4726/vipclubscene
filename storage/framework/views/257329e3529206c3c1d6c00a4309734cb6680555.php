<div>
    <div class="p-relative">
        <input class="form-control search-topnavi mt-2 mr-sm-2 " type="search" placeholder="<?php echo app('translator')->get('general.searchCreator'); ?>" aria-label="Search" wire:model.debounce.200ms="search">
...
<?php /**PATH C:\laragon\www\vipclub\resources\views/livewire/search-creators.blade.php ENDPATH**/ ?>