    ...
    <div class="<?php if(isset($cols)): ?> col-lg-<?php echo e($cols); ?> <?php else: ?> col-lg-4 <?php endif; ?> col-md-6 col-sm-6">
        <div class="creator_box">
            ...
            <div class="creator_txt">
                <div class="profile_im" style="margin-left:110px;margin-right:auto;">
...
<div class="container mt-3">
    ...
    <?php endif; ?>
</div><?php /**PATH /home/k9n6iup22po9/public_html/VIPCLUBSCENE/resources/views/creators/loop.blade.php ENDPATH**/ ?>