...
<div class="col-12 col-sm-8 col-md-9 col-lg-10 text-center text-sm-left">
	<div class="row">
		<div class="col-12 col-sm-6">
			...
			<a href="<?php echo e($profile->url); ?>">
				<?php echo e('@'. $profile->name); ?> <?php if($profile->isVerified == 'Yes'): ?> <i class="fas fa-check-circle text-primary"></i> <?php endif; ?>  
			</a>
			<br><br>

			<i class="far fa-grin-stars mr-1"></i> <?php echo e($profile->fans_count); ?> 
			<!--Audiance-->
			<?php echo app('translator')->get('general.paid-fans'); ?>
			<br>
			
			<i class="fas fa-users"></i> <?php echo e($profile->followers->count()); ?>

			<!--Insiders-->
			<?php echo app('translator')->get('general.free-subscribers'); ?>
			<br>
		...
		<div class="col-12 col-sm-6">
			...
			<?php if($profile->monthlyFee): ?>
				...
				<?php if(auth()->check() && auth()->user()->hasSubscriptionTo($profile->user)): ?>
					<a href="<?php echo e(route('mySubscriptions')); ?>" class="btn btn-primary btn-sm mb-2"><i class="fas fa-eye"></i> <?php echo app('translator')->get('general.viewSubscriptio'); ?></a>
				<?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('sPGVKgn')) {
    $componentId = $_instance->getRenderedChildComponentId('sPGVKgn');
    $componentTag = $_instance->getRenderedChildComponentTagName('sPGVKgn');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sPGVKgn');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('sPGVKgn', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/k9n6iup22po9/public_html/VIPCLUBSCENE/resources/views/profile/user-profile.blade.php ENDPATH**/ ?>