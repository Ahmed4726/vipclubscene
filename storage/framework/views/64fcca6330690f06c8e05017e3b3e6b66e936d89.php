...
<html lang="en">
  <head>
    ...
    <meta name="application-name" content="<?php echo e(opt('laravel_short_pwa', 'VIPClubSceneApp')); ?>">
    ...
    <meta name="apple-mobile-web-app-title" content="<?php echo e(opt('laravel_short_pwa', 'VIPClubSceneApp')); ?>">
  ...
  <div id="main">
    ...
    <script type="text/javascript">
        swal({ title: '', icon: 'success', text: '<?php echo e($message); ?>' });
    </script>
<?php endif; ?>
...
</html><?php /**PATH C:\laragon\www\vipclub\resources\views/welcome.blade.php ENDPATH**/ ?>