...
('37', 'seo_title', 'VIP Club Scene - Paid Content Creators Platform'),
('38', 'seo_desc', 'REWARD YOUR FAVOURITE CREATORS HARD WORK WITH PHP PATRON CLONE SCRIPT'),
('39', 'seo_keys', 'vip club scene, vipclubscene clone script, php vipclubscene, php vipclubscene,  clone'),
('40', 'site_title', 'PHP VIP Club Scene'),
