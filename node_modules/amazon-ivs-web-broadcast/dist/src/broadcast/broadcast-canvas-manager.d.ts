...
import { MediaStreamManager } from '../client-common/media-stream-manager';
import { Maybe } from '../client-common/types';
 ...
 */
export declare class BroadcastCanvasManager {
    private config;
    ...
    private nextMix;
    /**
     * Instantiates the [[BroadcastCanvasManager]].
     *
     * @param config - [[Config]]
     */
    ...
    /**
     * Starts the [[BroadcastCanvasManager]] and the [[Scheduler]] to begin compositing.
     */
    start(): void;
    /**
     * Stops the [[BroadcastCanvasManager]] and terminates the [[Scheduler]]'s WebWorker.
     */
    stop(): void;
    /**
     * Returns a boolean value representing the state of [[BroadcastCanvasManager#running]]
     */
    isCapturing(): boolean;
    /**
